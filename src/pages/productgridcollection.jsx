...
import 'iziToast/dist/css/iziToast.min.css';  // Import iziToast's CSS for styling



const Productgridcollection = (props, { onDataFetched }) => {
        ...
        const fetchData = async () => {
            ...
            try {
                const response = await fetch(
                    `https://utsarvajewels.com/api/crud?get_latest_design&page=${props.page}`
                );
                                                    ...
                                                    <ul className="d-flex align-items-center">
                                                        ...
                                                        <li className="product-cart">
                                                            <a
                                                                href="#"
                                                                className="d-inline-flex align-items-center justify-content-center position-relative overflow-hidden"
                                                                data-bs-target="#quickview-popup"
                                ...
                                <ul className="pagination align-items-center justify-content-center ">
                                    {
                                        props.page > 1 && (
                                            <li>
                                                <Link className="page-number border d-inline-flex align-items-center justify-content-center text-center" to={`/Collections/${props.page - 1}`}>
                                    ...
                                    {pages.map((page, index) => (
                                        <li key={index}>
                                            {page.i == props.page ? (
                                                <Link className="page-number active d-inline-flex align-items-center justify-content-center text-center" to={`/Collections/${page.i}`}>{page.i}</Link>
                                            ) : (
                                                <Link className="page-number border d-inline-flex align-items-center justify-content-center text-center" to={`/Collections/${page.i}`}>{page.i}</Link>
                                            )}
                                        </li>
                                    ))}
